...
for i in range(len(hidromet_gdf)):
    ...
    for j in time_delta:
        ...
        prev_percip = precip_data[date_prev.year].sel(time=date_prev)

        stats = zonal_stats(
            geom,
            prev_percip.values,
            affine=prev_percip.rio.transform(),
            stats="mean",
            nodata=-9999,
            all_touched=True
        )
...
#         daily = precip_data[2025].sel(time=date_prev)
#         stats = zonal_stats(
#             geom,
#             daily.values,
...
#         date_prev = hidromet_gdf.iloc[i].date - pd.Timedelta(days=1)
#         daily = precip_data[2024].sel(time=date_prev)
#         stats = zonal_stats(
#             geom,
#             daily.values,
#             affine=daily.rio.transform(),
...
#         date_prev = hidromet_gdf.iloc[i].date - pd.Timedelta(days=1)
#         daily = precip_data[2023].sel(time=date_prev)
#         stats = zonal_stats(
#             geom,
#             daily.values,
#             affine=daily.rio.transform(),
...
#         date_prev = hidromet_gdf.iloc[i].date - pd.Timedelta(days=1)
#         daily = precip_data[2022].sel(time=date_prev)
#         stats = zonal_stats(
#             geom,
#             daily.values,
#             affine=daily.rio.transform(),
...
#         date_prev = hidromet_gdf.iloc[i].date - pd.Timedelta(days=1)
#         daily = precip_data[2021].sel(time=date_prev)
#         stats = zonal_stats(
#             geom,
#             daily.values,
#             affine=daily.rio.transform(),
...
precip_per_disaster.to_excel("output/precip_7days_per_disaster.xlsx")
